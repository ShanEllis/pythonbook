...
3. **What would be the value stored in `modulo_time` after executing the following?**
...
9. **What would be the value stored in `my_value` after executing the following?**
