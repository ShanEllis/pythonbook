---
interact_link: content/04-functions/functions.ipynb
kernel_name: python3
title: 'Functions'
prev_page:
...
3. **Update your `greet` function to include an informative docstring**.
<br>

4. **Given the following, what would `print_numbers(5, 12.2)` print?**
...
5. **Given the following function, what would `string_manipulator('abcde')` return?**
...
6. **Given the following function, what would `exponentiate(exponent = 2, number = 4)` return**?
